...
//     }
// }
// console.log(canWeDeliver(85204)) //is in list, returns in delivery zone
// console.log(canWeDeliver(85207)) //not in list, returns apology message
...
// const canWeDeliver = deliveryAreaZipCodes.forEach((zip, i => {
//     if (zip === i){
//         return `You're in our delivery zone!`
//     } else {
//         return `Sorry, we can't deliver to that address`
